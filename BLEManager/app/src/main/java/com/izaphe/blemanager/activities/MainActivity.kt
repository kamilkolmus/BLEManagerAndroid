...
import com.izaphe.blemanager.fragments.FragmentBleDevices
import com.izaphe.blemanager.fragments.FragmentBleServices
...
//                    .setAction("Action", null).show()
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.action_about ->
            {Snackbar.make(window.decorView.rootView, "Created by Kamil Kolmus ", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show()
                return true
            }
